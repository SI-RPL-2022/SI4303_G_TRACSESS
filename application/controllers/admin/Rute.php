...
class Rute extends CI_Controller{
	...
	public function index($action='',$id=''){
		...
		$data['tableTitle'] = array('Tanggal Berangkat','Tanggal Tiba','Waktu Berangkat','Waktu Tiba','Asal','Tujuan','Harga');
		$data['tableField'] = array('depart_at','arrive_at','depart_time','arrive_time','place_name_from','place_name_to','price');
