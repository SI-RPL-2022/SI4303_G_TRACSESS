...
class Transportation extends CI_Controller{
	...
	public function index($action='',$id=''){
		...
		$data['tableTitle'] = array('Kode Kereta','Nama kereta','Kelas','Jumlah Kursi');
		$data['tableField'] = array('transportation_code','transportation_name','class_name','seat_qty');
		$data['inputType'] = array(
								...
								array('type'=>'select','label'=>'Data Transportasi','name'=>'id_transportation_type'
