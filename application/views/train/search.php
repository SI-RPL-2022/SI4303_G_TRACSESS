    ...
    <div class="row"> 
      ...
      <div style="display: <?php if(!empty($_SESSION['cart'])){echo "block";}else{echo "none";} ?>" id="orderBtn">
        <div class="fixed-action-btn">
          <a id="btnPesan" href="#confirm" class="btn btn-large blue darken-2 animated modal-trigger">
            <i class="large material-icons inline-text">shopping_cart</i> Lanjutkan Pemesanan
          </a>
        </div>
      </div>
              ...
              if(empty($berangkat)){
                ...
                <tr>
                  <td>
                    ...
                    <span><?=$b->transportation_code?></span>
                  </td>
                  ...
                  <td style="text-align:center">
                    <span class="price blue-text darken-text-5"><?=rupiah($b->price)?>/Pax</span>
      ...
      <?php }else{
        ...
        <div style="display: none" id="orderBtn">
          <div class="fixed-action-btn">
            <a id="btnPesan" href="#confirm" class="btn btn-large teal lighten-2 animated modal-trigger">
              <i class="large material-icons inline-text">shopping_cart</i> LANJUTKAN PEMESANAN
            </a>
          </div>
        </div>
