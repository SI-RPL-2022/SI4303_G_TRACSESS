        ...
        <div class="card grey lighten-4">
          ...
          <div class="card-content white">  
            ...
            <div class="row">    
               ...
               <?php if($o->status=='Tertunda'&&$o->check_in=='Belum CekIn'){ ?>  
                <a href="<?=site_url('user/upload/'.$o->id_order.'')?>" class="btn green"><i class="material-icons inline-text">attachment</i> Upload Bukti TF</a>
                <?php }else{
                  ?>    
              ...
              <?php if($o->status=='Terbayar'&&$o->check_in=='Belum CekIn'){ ?>             
              ...
              <?php if($tgl>=date('Y-m-d H:i:s')&&$o->status=='Terbayar'&&$o->check_in=='Belum CekIn'){ ?>  
                    ...
                    <tbody>
                      <tr>
                        <td width="80px">
                          ...
                          <td><?=$i[0]->transportation_name?><br><span class="light"><?=$i[0]->class_name?></span>
                          </td>
                      ...
                      <p class="t"><?=sel_jam($i[0]->depart_at.' '.$i[0]->depart_time,$i[0]->arrive_at.' '.$i[0]->arrive_time)?></p>
  ...
  <?php } ?>
                  ...
                  ?>
                    ...
                    <hr style="width:500px; margin-right: 40px; margin-top: 100px;">
                     <p style="text-align:right;"> <i>Lokasi Terkini Kereta <?=$loc[0]->transportation_name?> Berada di Stasiun <?=$loc[0]->address?> Pada Pukul <?=$loc[0]->Time?></i></p>
