...
<!--           <img class="img-brand" src="<?= base_url() . "assets/" ?>images/logo.png" style ="width:50px"> -->
        ...
        <ul class="right hide-on-med-and-down">
          <li> <a class='light dropdown-button grey lighten-5 black-text' href='#' data-activates='dropdown1' style="width:150px ">
              <i class="material-icons inline-text">account_circle</i> Petugas</a>
            <ul id='dropdown1' class='dropdown-content' >
              <li><a href="<?= base_url('petugas/logout') ?>">Keluar</a></li>
        ...
        <ul class="side-nav fixed grey lighten-4" id="mobile-demo">
          ...
          <li>
            <div class="user-view">
              ...
              <a href="#!name" style="padding-bottom: 20px;"><span class="white-text name">Petugas Stasiun</span></a>
            </div>
          </li>
          ...
          <li class="no-padding">
            <ul class="collapsible collapsible-accordion">
              <li>
                <a class="collapsible-header">
                  <i class="material-icons">train</i>Pesanan<i class="material-icons dropdown">arrow_drop_down</i></a>
                <div class="collapsible-body">
                  <ul>
                    <li><a href="<?= site_url('petugas/order') ?>">Cek In Tiket</a></li>
                    <li><a href="<?= site_url('petugas/order_cancel') ?>">List Ticket</a></li>
                  </ul>
                </div>
              </li>
            </ul>
