...
<!--               <a href="<?=site_url('petugas/'.$page.'/export')?>" class="btn waves-effect waves-light block"><i class="material-icons inline-text">keyboard_backspace</i> Export CSV</a> -->
                            <a href="<?=site_url('petugas/'.$page.'/index/rec')?>" class="btn waves-effect waves-light block"><i class="material-icons inline-text">cloud</i> Buat Rekap Cek In</a>
<!--               <a href="#truncate" class="btn waves-effect modal-trigger waves-light block"><i class="material-icons inline-text">delete_forever</i> Hapus Semua Data</a> -->
              <div id="truncate" class="modal deletemodal">
                ...
                <div class="modal-footer">
                  ...
                  <a href="<?=site_url('petugas/'.$page.'/truncate')?>" class="waves-effect waves-green btn blue modal-action modal-close">YA</a>
                </div>
              </div>
            </div>
          </div>
