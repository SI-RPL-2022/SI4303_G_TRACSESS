...
<!--           <img class="img-brand" src="<?= base_url() . "assets/" ?>images/logo.png" style ="width:50px"> -->
        </a>
        ...
        <ul class="right hide-on-med-and-down">
          <li> <a class='light dropdown-button grey lighten-5 black-text' href='#' data-activates='dropdown1' style="width:150px ">
              <i class="material-icons inline-text">account_circle</i> Akun Stasiun</a>
            <ul id='dropdown1' class='dropdown-content' >
              <li><a href="<?= base_url('stasiun/logout') ?>">Keluar</a></li>
<!--               <li style="padding:15px; color:gray; ">TRACCESS APP</li>
        ...
        <ul class="side-nav fixed grey lighten-4" id="mobile-demo">
          <div class="side-logo hide-sm">
            <img src="<?= base_url() . "assets/" ?>images/logo-text.png" style ="width:275px">
            ...
            <ul class="collapsible collapsible-accordion">
              <li>
                ...
                <div class="collapsible-body">
                  <ul>
                    <li><a href="<?= site_url('stasiun/transportation') ?>">Daftar kereta api</a></li>
                    <li><a href="<?= site_url('stasiun/transportation_class') ?>">Kelas Kereta Api</a></li>
                    <li><a href="<?= site_url('stasiun/transportation_company') ?>">Perusahaan Transportasi</a></li> 
                  </ul>
                </div>
              </li>
            </ul>
          </li> -->
<!--           <li><a href="<?= site_url('stasiun/place') ?>"><i class="material-icons">location_on</i>Data Stasiun</a></li>
          <li><a href="<?= site_url('stasiun/rute') ?>"><i class="material-icons">directions</i>Rute Kereta</a></li> -->
          <li><a href="<?= site_url('stasiun/costumer') ?>"><i class="material-icons">group</i>Data Akun Petugas</a></li>
         <!--  <li class="no-padding">
            <ul class="collapsible collapsible-accordion">
              <li>
                <a class="collapsible-header">
                ...
                <div class="collapsible-body">
                  <ul>
                    <li><a href="<?= site_url('stasiun/order') ?>">Daftar Pesanan</a></li>
                    <li><a href="<?= site_url('stasiun/order_cancel') ?>">Permintaan Pembatalan</a></li>
                  </ul>
                </div>
              </li>
            </ul>
  ...
  <footer class="page-footer">
    <div class="footer-copyright blue">
      <div class="container">
        <span>Copyright &copy; 2022 <a class="grey-text text-lighten-4" href="<?= base_url() ?>" target="_blank">Traccess</a> All rights reserved.</span>
  ...
  <script type="text/javascript">
    function pTrans() {
      ...
      $.post('<?= base_url('stasiun/transportation/gClass') ?>', {
        id_type: id_type
      }, function(data) {
        $('#id_transportation_class').html(data);
        $('#id_transportation_class').material_select();
      });
      $.post('<?= base_url('stasiun/transportation/gCompany') ?>', {
        id_type: id_type
      }, function(data) {
    ...
    function pRute() {
      var id_type = $('#id_transportation_type').val();
      $.post('<?= base_url('stasiun/rute/gPlace') ?>', {
        id_type: id_type
      }, function(data) {
      ...
      $.post('<?= base_url('stasiun/rute/gTrans') ?>', {
        id_type: id_type
      }, function(data) {
