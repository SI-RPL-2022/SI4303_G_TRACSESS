      ...
      <div class="row">
        ...
        <div class="col m6 s12">
         <div class="nav-breadcrumb blue">
          <a href="#!" class="breadcrumb">Stasiun</a>
      ...
      <div class="card grey lighten-4">
        ...
        <div class="card-content white">
          <div class="container">
            ...
            <?php
            if($action=='add'){
              echo form_open('stasiun/'.$page.'/p/insert');
            }elseif($action=='edit'){
              echo form_open('stasiun/'.$page.'/p/update/'.$aidi.'');
            }
            ?>  
            <div id="message"></div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: center">
                  <a href="<?=site_url('stasiun/'.$page.'/index/edit/'.$d->$primary_key.'')?>" class="btn waves-effect waves-light action green"><i class="material-icons">edit</i></a>
